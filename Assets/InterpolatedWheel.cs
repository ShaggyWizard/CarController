...
public class InterpolatedWheel : MonoBehaviour, IInterpolatedTransform
{
    ...
    public void LateFixedUpdate()
    {
        ...
        TransformData data = new TransformData(transform);
        _collider.GetWorldPose(out data.position, out data.rotation);
        _lastTransforms[_newTransformIndex] = data;
    }
